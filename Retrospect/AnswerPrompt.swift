...
//    
//    var promptBinding: Binding<[APIQuestionAnswer]>? {
//        guard let questionAnswers = globalState.focusCapsule?.questionAnswers else { return nil }
//        return Binding(
//            get: { questionAnswers },
//            set: { globalState.focusCapsule?.questionAnswers = $0 }
//        )
//    }
//
//    var body: some View {
//        if let prompts = promptBinding {
//            VStack {
...
//                            VStack {
//                                VStack {
//                                    if let textPrompt = prompts[index].prompt {
//                                        Text("\(textPrompt.wrappedValue)")
...
//                        let body: [String: Any] = ["capsuleId": globalState.focusCapsule.id, "QuestionAnswerId": prompts[selectedIndex].id!]
...
//}
//
//@MainActor func uploadPrompts(globalState: EnvironmentObject<GlobalState>) {
//    guard let focusCapsule = globalState.wrappedValue.focusCapsule else { return }
//    let questionAnswers = focusCapsule.questionAnswers 
//    
//    for index in questionAnswers {
//        if let qa = focusCapsule.questionAnswers[index] {
//            if !qa.uploaded || qa.edited {
//                if !qa.uploaded {
//                    let body: [String: Any] =
